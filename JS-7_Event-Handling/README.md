My notes: in this assignment we made a JavaScript function where as you click the button, it would change the background color of the webpage. Didn't know that JavaScript could do this :O
